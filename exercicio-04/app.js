...
*/
const my3FavoriteTVShows = ['Furia em alto Mar', 'Fury', 'Voo']
const sentence = `Meus 3 filmes favoritas são: ${my3FavoriteTVShows.join(', ')}.`.replace('y,', 'y e')
